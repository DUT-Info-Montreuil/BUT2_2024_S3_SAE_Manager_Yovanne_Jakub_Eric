...
class VueRessourceBase extends VueGenerique
{
    public function __construct()
    {
        parent::__construct();
    }
    public function afficherAllRessourceBase($allRessources, $actionModifierRessource, $actionSupprimerRessource, $actionCreerRessource){
        ?>
        <div class="container mt-4">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?= $actionModifierRessource ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <form action="<?= $actionSupprimerRessource ?>" method="post" class="d-inline">
                                        <input type="hidden" name="id_ressource" value="<?= htmlspecialchars($ressource['id_ressource']) ?>">
            ...
            <div class="d-flex justify-content-end mt-4">
                <a href="<?= $actionCreerRessource ?>" class="btn btn-primary">
    ...
    public function formulaireCreerRessourceBase($actionSubmitRessource , $actionGestionRessourceSAE)
    {
        ?>
        <div class="container mt-4">
            <h1 class="mb-4">Créer une Nouvelle Ressource</h1>
            <form action="<?= $actionSubmitRessource ?>" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <a href="<?= $actionGestionRessourceSAE ?>" class="btn btn-secondary">Annuler</a>
            </form>
        </div>
        <?php
    }
