...
class VueDashboard extends VueGenerique
{
    ...
    public function renderDashboard($projectData, $groups, $evaluations, $resources, $soutenance, $rendu)
    {
        ...
        <div class="container mt-5">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <?php $this->renderProjectOverview($projectData); ?>
                </div>
                <div class="col-md-6">
                    <?php $this->renderGroups($groups); ?>
                </div>
            </div>

            <div class="row mb-4">
                <div class="col-md-6">
                    <?php $this->renderResources($resources); ?>
                </div>
                <div class="col-md-6">
                    <?php $this->renderEvaluations($evaluations); ?>
                </div>
            </div>

            <div class="row mb-4">
                <div class="col-md-6">
                    <?php $this->renderRendu($rendu); ?>
                </div>
                <div class="col-md-6">
                    <?php $this->renderSoutenances($soutenance); ?>
                </div>
            </div>
    ...
    private function renderProjectOverview($projectData)
    {
        ?>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <?php foreach ($group['notes'] as $note): ?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($note['nom_soutenance'] ?? $note['nom_rendu'] ?? 'N/A'); ?></td>
                                                <td><?php echo htmlspecialchars($note['note']) . '/' . htmlspecialchars($note['note_max']); ?></td>
                                                <td><?php echo htmlspecialchars($note['prenom'] . ' ' . $note['nom_etudiant']); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
    ...
    private function renderResources($resources)
    {
        ?>
        <div class="card shadow-lg rounded border-0">
    ...
    private function renderEvaluations($evaluations)
    {
        ?>
        <div class="card shadow-lg rounded border-0">
            <div class="card-header" style="background-color: #4223af; color: white; text-align: center; padding: 15px;">
    ...
    private function renderRendu($rendu)
    {
        ?>
        <div class="card shadow-lg rounded border-0">
    ...
    private function renderSoutenances($soutenance)
    {
        ?>
        <div class="card shadow-lg rounded border-0">
