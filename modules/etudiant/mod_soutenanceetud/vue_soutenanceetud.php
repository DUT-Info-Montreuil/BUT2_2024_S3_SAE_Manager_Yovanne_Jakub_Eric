                        ...
                        <div class="accordion-item mb-3">
                            ...
                            <div id="collapse-<?= $index ?>" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body p-3">
                                    ...
                                    <div class="mb-3">
                                        <p class="bg-light p-2 border rounded"><strong>Date de Soutenance
                                                :</strong> <?= htmlspecialchars($soutenance['date_soutenance']) ?></p>
                                    </div>
                                    ...
                                    <?php if (!empty($soutenance['note'])): ?>
                                        <div class="p-3 bg-light border rounded">
                                            ...
                                            <p class="mb-0"><strong>Commentaire
                                                    :</strong> <?= htmlspecialchars($soutenance['commentaire'])?>
                                            </p>
                                        </div>
                                    <?php endif; ?>
                                </div>
